...
import { SavioTimelineHomeHandler, SAVIO_TIMELINE_HOME_PAGE_NAME } from './services/handlers/timeline-home';
...
const mainMenuHomeChildrenRoutes: Routes = [
    ...
    {
        // Savio: Timeline page registered as a home sub-tab.
        path: SAVIO_TIMELINE_HOME_PAGE_NAME,
        loadComponent: () => import('@features/courses/pages/timeline/timeline'),
    },
];
...
@NgModule({
    ...
    providers: [
        provideAppInitializer(() => {
            ...
            CoreMainMenuHomeDelegate.registerHandler(SavioTimelineHomeHandler.instance);
